...
**评分参考**：
- **权威性**：国际组织/中央政府 = 5.0，地方政府 = 3.0-4.0
- **数据质量**：官方统计 = 4.5-5.0，第三方整理 = 3.0-4.0
- **覆盖范围**：全球/全国 = 5.0，区域 = 3.0-4.0
...
例如，添加到 `sources/china/finance/README.md`：
...
1. **中国人民银行** (`china-pbc`) ⭐💎
   ...
   - 数据格式：JSON, Excel, PDF
   - 访问类型：开放
   - [查看详情](banking/pbc.json)

2. **新增数据源** (`new-source-id`) ⭐
   - 权威性：4.5
   - 数据格式：CSV, Excel
   - 访问类型：注册
   - [查看详情](banking/new-source.json)
```
