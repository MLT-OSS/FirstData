...
#### QS World University Rankings - QS世界大学排名
- **文件**: [qs-world-university-rankings.json](P-education/qs-world-university-rankings.json)
- **权威等级**: market
- **类型**: Quacquarelli Symonds | 大学排名
- **数据格式**: Web, PDF
- **访问类型**: 需注册
- **涵盖**: 全球1500+大学，104个地区
- **更新频率**: 年度
- **特色**: 全球最广泛参考的国际大学排名之一，基于学术声誉(30%)、师均引用率(20%)、雇主声誉(15%)、师生比(10%)、国际教师比例(5%)、国际学生比例(5%)和可持续发展(5%)六大核心指标进行评估
