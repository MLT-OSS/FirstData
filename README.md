...
<details>
<summary><b>案例1：研究人员 - 发展中国家经济数据 📚</b></summary>
...
<details>
<summary><b>案例2：数据分析师 - 中国货币政策数据 💰</b></summary>
...
<details>
<summary><b>案例3：政策制定者 - 全球气候数据 🌍</b></summary>
...
<details>
<summary><b>案例4（进阶）：智能检索+操作说明书一站式方案 📊</b></summary>

**场景**：
> "帮我找到智谱AI的最新招股书，分析一下他们为什么亏损那么多，现金余额为什么还跟融资额度差不多"
...
- ❌ **无操作指引**：即使找到官网，不知道如何导航下载

**使用 DataSource Hub MCP Agent 的完整工作流：**
...
1. 香港交易及结算所有限公司 (HKEX)
   ...
   📊 核心数据：
   - 智谱AI于2025年12月向港交所递交招股书
   - 2021-2024上半年累计营收约6.85亿元
   - 累计净亏损约62亿元
   - 截至2025年年中账面现金约25.5亿元
...
我们建立了一个**操作说明书数据库**，涵盖常用权威数据源的网站导航和下载步骤。

**在数据库中检索披露易（HKEXnews）网站操作指令**：
```
source: https://www.hkexnews.hk
operation: 如何下载智谱ai的招股书?
```
**说明书检索结果**：
```
📋 网站操作说明书：
...
4. 在主内容区找到标签页切换区域，点击 "GEM" 标签页切换到创业板
5. 在新上市公司列表中查找 "智谱" 或 "Zhipu"
...
3. 在右侧边栏找到新上市报告区域
4. 点击主板报告下载列表
5. 在报告列表中找到包含智谱AI信息的年度报告
6. 点击相应的 "New Listing Report" 下载链接
```
...
**亏损原因分析**：
1. **大规模研发投入**：AI大模型训练需要巨额算力成本
   - 智谱IPO募资70%（约29亿港元）用于通用AI大模型研发
   - 模型训练、算力租赁、人才成本高昂

2. **商业化初期**：
   - 2022-2024年收入快速增长（年复合增长率130%）
   - 但营收规模仍远小于研发投入

3. **行业特性**：大模型企业普遍处于"先投入后盈利"阶段

**现金余额合理性解释**：
- 账面现金约25.5亿元，看似与融资额度相当
- **合理原因**：
  1. 融资资金主要用于研发投入，而非运营开支
  2. 大模型训练成本高但支付周期长（算力租赁按周期结算）
  3. 现金储备是为了应对未来持续的研发投入需求
  4. IPO募资净额41.7亿港元将进一步充实现金储备
