...
配置完成后，你可以在Claude Desktop、Cline、Cursor等支持MCP的AI平台中直接用自然语言提问，MCP Agent会自动调用工具为你查找数据源。

---

### 💬 实际使用案例

#### 案例1：避免AI幻觉 - 查找上市公司披露文件 📊

**你的问题：**
> "我需要查找某家公司的招股说明书和财务披露信息，在哪里能找到官方权威版本？"
...
│   └── datasource-schema.json # 元数据标准定义
│
├── scripts/                    # 🔧 实用工具脚本
